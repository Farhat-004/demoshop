...
Note: Backend needs to be hosted in a different hosting platform. currently it is hosted in railway, but the free trial has expired.
...
- Role-based authorization (partially implemented but failed)
